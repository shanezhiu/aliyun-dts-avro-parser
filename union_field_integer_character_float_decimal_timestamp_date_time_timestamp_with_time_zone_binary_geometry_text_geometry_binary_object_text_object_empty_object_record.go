...
func (r UnionFieldIntegerCharacterFloatDecimalTimestampDateTimeTimestampWithTimeZoneBinaryGeometryTextGeometryBinaryObjectTextObjectEmptyObjectRecord) MarshalJSON() ([]byte, error) {
	...
	switch r.UnionType {
	case UnionFieldIntegerCharacterFloatDecimalTimestampDateTimeTimestampWithTimeZoneBinaryGeometryTextGeometryBinaryObjectTextObjectEmptyObjectRecordTypeEnumField:
		return json.Marshal(map[string]interface{}{"com.alibaba.dts.formats.avro.Field": r.Field})
	case UnionFieldIntegerCharacterFloatDecimalTimestampDateTimeTimestampWithTimeZoneBinaryGeometryTextGeometryBinaryObjectTextObjectEmptyObjectRecordTypeEnumInteger:
	...
	case UnionFieldIntegerCharacterFloatDecimalTimestampDateTimeTimestampWithTimeZoneBinaryGeometryTextGeometryBinaryObjectTextObjectEmptyObjectRecordTypeEnumRecord:
		return json.Marshal(map[string]interface{}{"com.alibaba.dts.formats.avro.Record": r.Record})
	}
...
func (r *UnionFieldIntegerCharacterFloatDecimalTimestampDateTimeTimestampWithTimeZoneBinaryGeometryTextGeometryBinaryObjectTextObjectEmptyObjectRecord) UnmarshalJSON(data []byte) error {
	...
	if value, ok := fields["com.alibaba.dts.formats.avro.Field"]; ok {
		r.UnionType = 0
	...
	if value, ok := fields["com.alibaba.dts.formats.avro.Record"]; ok {
		r.UnionType = 13
